...
# Add the ceu_crawler directory to path
...
def cmd_crawl(args):
    ...
    from ceu_crawler.core import ProviderRegistry
...
def cmd_process(args):
    ...
    cmd = [sys.executable, "-m", "ceu_crawler.processing", "process",
...
def cmd_explore(args):
    ...
    try:
        from ceu_crawler.tools import HtmlExplorer
    ...
    if args.test_selector:
        try:
            from ceu_crawler.tools import SelectorTester
        except ImportError:
...
def cmd_validate(args):
    ...
    from ceu_crawler.tools import ConfigValidator
...
def cmd_stats(args):
    ...
    cmd = [sys.executable, "-m", "ceu_crawler.processing", "stats"]
